...
with open('/home/chiara/archive/flights_crop.csv', 'r') as csvfile:
    ...
    with open('/home/chiara/Documenti/GitHub/ProgettoBig/flask_app/timestamp1.csv', 'w', newline='') as output_csvfile:
        ...
        """ # Crea un nuovo file CSV in modalità di scrittura
    with open('/home/chiara/Documenti/GitHub/ProgettoBig/flask_app/intervalli1.csv', 'w', newline='') as output_csvfile:
        # Crea un oggetto scrittore CSV
        csvwriter = csv.writer(output_csvfile)
